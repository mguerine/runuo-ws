...
namespace Server.Items
{
	...
	public class CraftAttributeInfo
	{
		...
		static CraftAttributeInfo()
		{
			...
			valorite.ArmorPhysicalResist = 7;
			valorite.ArmorFireResist = 7;
			...
			if ( Core.ML )
			{
				valorite.RunicMinIntensity = 100;
			...
			barbed.ArmorFireResist = 4;
			barbed.ArmorColdResist = 5;
			barbed.ArmorPoisonResist = 6;
			barbed.ArmorEnergyResist = 7;
			barbed.RunicMinAttributes = 5;
