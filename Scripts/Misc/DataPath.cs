...
namespace Server.Misc
{
	public class DataPath
	{
		 ...
		 */
		//private static string CustomPath = @"C:\Arquivos de Programas\EA Games\Ultima Online 2D Client";
		private static string CustomPath = @"D:\Program Files\EA Games\Ultima Online 2D Client";
