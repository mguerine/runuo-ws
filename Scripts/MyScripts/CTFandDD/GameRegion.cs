...
namespace Server.Regions
{
	public class GameRegion : BaseRegion
	{
        ...
        public GameRegion(int type) : base("Game Arena", Map.Felucca, 100, m_bounds)
		{
            switch (type)
            {
		...
		public override bool OnBeginSpellCast( Mobile m, ISpell s )
		{
			if ( m.AccessLevel == AccessLevel.Player && 
				...
				s is PoisonFieldSpell || s is EnergyFieldSpell || s is WallOfStoneSpell || s is ParalyzeFieldSpell || s is FireFieldSpell  || s is AnimalForm) )
			{
